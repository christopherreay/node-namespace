...
export { NotFound, batch, configure, namespace as default, equals, exists, expand, flatten, getIfExists, getMustEmpty, getMustExist, getOrDefault, graftComplement, isNotFound, path, rm, rmMustExist, setMustExist, setNotExists, setOrDefault, setOverwrite, traverse, venn };
